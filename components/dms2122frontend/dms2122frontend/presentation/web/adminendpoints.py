...
class AdminEndpoints:
    ...
    def post_admin_users_new(auth_service: AuthService) -> Union[Response, Text]:
        ...
        created_user = WebUser.create_user(
            auth_service, request.form["username"], request.form["password"]
        )
        if not created_user:
            return redirect(url_for("get_admin_users_new"))
    ...
    def post_admin_users_edit(auth_service: AuthService) -> Union[Response, Text]:
        ...
        successful &= WebUser.update_user_roles(
            auth_service, request.form["username"], request.form.getlist("roles")
        )
